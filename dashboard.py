...
@media (max-width:820px){
  /* padding/gap tightened well below the desktop values (44px/44px) rather
     ...
     (10px vs 28px) -- two rounds of real-device photos showed dead navy
     space below the copy paragraph before the hero ends; top padding stays
     since it reads fine against the breadcrumb bar above. herowrap's own
     margin-bottom also cut (14px to 6px) since that stacked with .wrap's
     mobile padding-top to widen the white gap before the "Read this
     first" notice card. */
  .hero-inner{grid-template-columns:1fr;padding:28px 20px 10px;gap:12px}
